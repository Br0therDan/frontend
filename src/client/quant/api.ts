...
export const BacktestsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator = BacktestsApiAxiosParamCreator(configuration)
  return {
    /**
     *
     * @summary Create Backtest
...
export const WatchlistsApiAxiosParamCreator = function (
  ...
  return {
    ...
    watchlistsDeleteWatchlist: async (
      ...
      // verify required parameter 'watchlistId' is not null or undefined
      assertParamExists('watchlistsDeleteWatchlist', 'watchlistId', watchlistId)
    ...
    watchlistsUpdateWatchlist: async (
      ...
      // verify required parameter 'watchlistId' is not null or undefined
      assertParamExists('watchlistsUpdateWatchlist', 'watchlistId', watchlistId)
...
export const YahooFinanceApiAxiosParamCreator = function (
  ...
  return {
    ...
    yahooFinanceGetInstitutionalHolders: async (
      ...
      // verify required parameter 'symbol' is not null or undefined
      assertParamExists('yahooFinanceGetInstitutionalHolders', 'symbol', symbol)
...
export const YahooFinanceApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.yahooFinanceGetCashflow(symbol, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.yahooFinanceGetEarnings(symbol, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
