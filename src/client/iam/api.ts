...
export const AdminApiAxiosParamCreator = function (
	...
	return {
		...
		adminDeleteSubscription: async (
			...
			const localVarPath =
				`/api/v1/admin/subscriptions/{subscription_id}`.replace(
					`{${"subscription_id"}}`,
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.adminCreateSubscription(
					subscriptionCreate,
					tokenFromCookie,
					options,
				);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["AdminApi.adminCreateSubscription"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.adminDeleteSubscription(
					subscriptionId,
					tokenFromCookie,
					options,
				);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["AdminApi.adminDeleteSubscription"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.adminReadApps(options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["AdminApi.adminReadApps"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		async adminReadSubscriptions(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<Array<SubscriptionPublic>>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.adminReadSubscriptions(
					userId,
					appName,
					tokenFromCookie,
					options,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["AdminApi.adminReadSubscriptions"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.adminUpdateSubscription(
					subscriptionId,
					subscriptionUpdate,
					tokenFromCookie,
					options,
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap["AdminApi.adminUpdateSubscription"]?.[
					localVarOperationServerIndex
				]?.url;
			return (axios, basePath) =>
				createRequestFunction(
...
export const AdminApiFactory = function (
	...
	return {
		...
		adminCreateSubscription(
			...
			return localVarFp
				.adminCreateSubscription(subscriptionCreate, tokenFromCookie, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * [관리자 전용] 사용자 생성
		...
		adminDeleteSubscription(
			...
			return localVarFp
				.adminDeleteSubscription(subscriptionId, tokenFromCookie, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * 사용자 삭제
		...
		adminReadSubscriptions(
			...
			return localVarFp
				.adminReadSubscriptions(userId, appName, tokenFromCookie, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * 특정 사용자 정보 조회
		...
		adminReadUsers(
			...
			return localVarFp
				.adminReadUsers(appName, tokenFromCookie, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * [관리자 전용] 서비스 정보 수정
...
export class AdminApi extends BaseAPI {
	 ...
	 * @memberof AdminApi
	 */
	public adminCreateSubscription(
		subscriptionCreate: SubscriptionCreate,
		tokenFromCookie?: string | null,
		options?: RawAxiosRequestConfig,
	) {
	 ...
	 * @memberof AdminApi
	 */
	public adminDeleteSubscription(
		subscriptionId: string,
		tokenFromCookie?: string | null,
		options?: RawAxiosRequestConfig,
	) {
	 ...
	 * @memberof AdminApi
	 */
	public adminUpdateSubscription(
		subscriptionId: string,
		subscriptionUpdate: SubscriptionUpdate,
		tokenFromCookie?: string | null,
		options?: RawAxiosRequestConfig,
