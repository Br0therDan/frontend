...
const UserInformation = () => {
  ...
  const userUpdate = useCallback(async (data: UserUpdateMe) => {
    try {
      setLoading(true);
  ...
  const onSubmitUserInfo: SubmitHandler<UserPublic> = useCallback((data) => {
          ...
          <CardContent className="flex flex-col md:flex-row">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 min-w-64 gap-6 w-full p-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <ProviderIcons
                  providers={currentUser?.oauth_accounts || []}
                />
              </div>
              <FormField
                id="mobile_phone"
              ...
              <FormField
                ...
                register={register}
                errors={errors}
                placeholder={formatDate(currentUser?.birthday) || 'Date of Birth'}
                isEditMode={editMode}
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  {currentUser?.is_active ? t('user.active') : t('user.inactive')}
                </div>
              </div>
            </div>
          </CardContent>
